...
Examples:
  ...
  if (!schemeName || !templName) {
    console.error('fatal: You did not supply valid arguments. See \'base16-builder -h\' for help/examples.');
    return;
  }
  ...
  try {
    ...
    console.log(`Successfully built theme. You can find the theme at ${outPath}`);
  } catch (e) {
